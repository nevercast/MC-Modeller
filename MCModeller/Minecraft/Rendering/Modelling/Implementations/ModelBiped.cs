...
namespace MCModeller.Minecraft.Rendering.Modelling.Implementations
{
    public class ModelBiped : ModelBase
    {
        ...
        public new void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6)
        {
            ...
            {
                var7 = this.onGround;
                this.bipedBody.rotateAngleY = MathHelper.Sin(MathHelper.SqrtF(var7) * (float)Math.PI * 2.0F) * 0.2F;
